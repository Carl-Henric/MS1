...
---
## Testing
Google Devtools has been used to test the site on a daily basis. All testing has been made manually.
...
---
## Bugs
Among this project, it's been two kinds of bugs that have been repetitive. See below. 
...
- **Collapse menu**: The menu works great on desktop but when on mobile the menu does´not collapse after clicking which it's supposed to. I have tested all the answers that I got from Google but it still doesn't work correctly. 
---
## Deployment
